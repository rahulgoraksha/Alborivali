...
-------------------19/01/2025------------------------------------
create database bkshop1
use bkshop1
--bakers
create table bakers(
bakerid int primary key,
bakername varchar(50) not null,
bakertelephone varchar(10) not null,
bakeraddress varchar(255) null)

--orders
create table orders(
orderid int primary key,
orderCreatedDate datetime not null,
orderDelivryDate datetime not null,
custID int not null)
...
productid int,
bakerid int ,
pricingdate datetime primary key ,
...
--bakersproduct
create table bakersproducts(
bakerid int,
productid int,
pricingdate datetime not null,
price money not null,
stocklevel bigint not null,
primary key (bakerid, productid, pricingdate),
foreign key (bakerid) references bakers(bakerid))


alter table productorders add constraint fk_pricingdate 
foreign key (pricingdate) references bakersproducts(pricingdate) 
...
declare @empsal int;
select @empsal = salary from employee where empid = 1

if @empsal > 5000
print ' employee has a sal 
